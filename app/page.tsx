  ...
  return (
    <main className="bg-[#0a0a0a] text-white min-h-screen overflow-x-hidden scroll-smooth relative w-full max-w-[100vw]">
      ...
      <section
        ref={homeRef}
        id="home"
        className="min-h-screen flex flex-col-reverse lg:flex-row items-center justify-between px-6 md:px-16 relative overflow-hidden w-full pt-20"
      >
        {/* Left Content */}
        <motion.div
      ...
      {/* ABOUT ME SECTION */}
      <section ref={aboutRef} id="about" className="py-32 px-6 w-full">
      ...
      {/* CONTACT SECTION */}
      <section ref={contactRef} id="contact" className="py-32 px-6 bg-white/[0.01] w-full">
